...
public class UserWithOrdersDto {
  ...
  public UserWithOrdersDto(User entity) {
  ...
  private UserWithOrdersDto(Builder builder) {
    id = builder.id;
    name = builder.name;
  ...
  public boolean equals(Object o) {
    ...
    UserWithOrdersDto that = (UserWithOrdersDto) o;
  ...
  public static class Builder {
    ...
    public UserWithOrdersDto build() {
      return new UserWithOrdersDto(this);
    }
  }
}
